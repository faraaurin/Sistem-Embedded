...
float h, t;
#define WIFI_SSID "bbldr"
#define WIFI_PASS "melonijo1315"

#define MAX_CONN_FAIL 50
#define MAX_LENGTH_WIFI_SSID 31
#define MAX_LENGTH_WIFI_PASS 63

#define TLG_TOKEN "1344962052:AAEQO-zX0KVRHFCrweEjve0AVEHxkPiq_GU" // token anakkendali_bot
...
void loop()
{
  ...
  if (t > 37 && state_t == 0) {
    ...
    msg.toCharArray(buff, 100);
    Bot.sendMessage("1489103347", buff);
  }
  else if (t <= 37) {
    state_t = 0;
